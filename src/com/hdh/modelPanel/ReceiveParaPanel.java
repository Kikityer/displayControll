...
/**
 * @ClassName ReceiveParaPanel
 * @Description TODO  接收参数模态框
 * @Author Kikityer
 * @Date 2019/3/21 14:34
 * @Version 1.0.0
 **/
public class ReceiveParaPanel extends JPanel implements MouseListener {

    JPanel jPanel1_2_1_2;

    //接收界面组件
    JLabel jLabel5,jLabel6,jLabel7,jLabel8,jLabel9,jLabel10,jLabel11,jLabel12,jLabel13; //发射界面（初始化界面）
    public static JComboBox jComboBox1,jComboBox2,jComboBox3;
    public static JTextField jtf1,jtf2,jtf3,jtf4,jtf5,jtf6;
    ...
    ReceiveParaPanel(){
        ...
        jPanel1_2_1_2.setBorder(BorderFactory.createMatteBorder(5, 5, 5, 5,  new Color(99,184,255)));
        ...
        jLabel7.setFont(new Font("Microsoft Yahei",Font.PLAIN,12));
        jtf2 = new JTextField();
        ...
        jLabel13 = new JLabel("接收通信时隙长度",JLabel.CENTER);
