...
/**
 * @ClassName JFreeChartUser4
 * @Description TODO  服务器4 星图1显示
 * @Author Kikityer
 * @Date 2019/3/21 14:26
 * @Version 1.0.0
 **/
public class JFreeChartUser4 {
    /**
     * 用户4服务器的星图显示
     */
    ...
    public static JPanel drawChart(){
        ...
        xyPlot.setBackgroundPaint(new Color(24,116,205)); //135,206,255
