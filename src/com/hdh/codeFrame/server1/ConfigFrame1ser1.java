...
/**
 * @ClassName ConfigFrame1ser1
 * @Description TODO   服务器1   发射模式下配置帧的组帧*****发射模式*****
 * @Author Kikityer
 * @Date 2019/3/21 13:56
 * @Version 1.0.0
 **/
public class ConfigFrame1ser1 {
    /**
     * 配置帧结构体变量：
    ...
    static byte[] srcId = {0x00,0x00};   //默认为0           1字节
    static byte[] desId = {0x00,0x01};   //显控向服务器发 1表示一号服务器 ，2表示二服务器 。。。            1字节
