...
/**
 * @ClassName ControlFrame4ser1
 * @Description TODO  服务器4   控制帧结构的组帧（结束接收控制指令）
 * @Author Kikityer
 * @Date 2019/3/21 13:58
 * @Version 1.0.0
 **/
public class ControlFrame4ser4 {
    /**
    ...
    public byte[][] controllPack4() throws ParseException {
        ...
        byte[] data = new byte[]{0x00,0x10};    //停止接收帧结构
        byte sum = 0;
