...
/**
 * @ClassName ControlFrame2ser1
 * @Description TODO  服务器4   控制帧结构的组帧（结束发送控制指令）
 * @Author Kikityer
 * @Date 2019/3/21 13:58
 * @Version 1.0.0
 **/
public class ControlFrame2ser4 {
    /**
    ...
    public byte[][] controllPack2() throws ParseException {
        ...
        byte[] data = new byte[]{0x00,0x02};    //开始发送帧结构
        byte sum = 0;
